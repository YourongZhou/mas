...
def basic_global_state() -> Dict[str, Any]:
    ...
    return {
        ...
        "docker_env_profile": None,
        "docker_env_signature": None,
        "docker_env_image": None,
        "docker_env_runtime": None,
        "docker_env_mode": None,
        "docker_env_cache_key": None,
        "docker_env_cache_volume": None,
        "docker_required_assets": None,
